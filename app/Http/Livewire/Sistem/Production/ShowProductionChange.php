...
class ShowProductionChange extends Component
{
    use WithPagination;
  ...
  ->paginate($this->cant);
        ...
        return view('livewire.sistem.production.show-production-change', compact('productions'))->layout('layouts.sistem');
    }
}
