...
class ShowProductionStop extends Component
{
    use WithPagination;
  ...
  ->paginate($this->cant);
        ...
        return view('livewire.sistem.production.show-production-stop', compact('productions'))->layout('layouts.sistem');
    }
}
