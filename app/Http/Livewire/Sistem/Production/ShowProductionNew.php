...
class ShowProductionNew extends Component
{
    use WithPagination;
 ...
 // ->orderBy(DB::raw('-`pry`'), $this->direction)
  ...
  ->paginate($this->cant);
        ...
        return view('livewire.sistem.production.show-production-new', compact('productions'))->layout('layouts.sistem');
    }
}
