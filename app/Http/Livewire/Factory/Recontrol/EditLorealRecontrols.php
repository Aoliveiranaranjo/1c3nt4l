...
class EditLorealRecontrols extends Component
{
    public $clients;
    ...
    public function save()
    {
        ...
        return redirect()->route('factory.recontrol.show.index.loreal');
    }
    public function render()
    {
        return view('livewire.factory.recontrol.edit-loreal-recontrols')->layout('layouts.factory');
    }
}
