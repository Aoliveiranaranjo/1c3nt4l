...
class ShowLorealRecontrols extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $recontrols = Recontrol::whereNull('history')
        ->where('client_id', 2)
        ->with('client')
        ...
        ->paginate(50);
        return view('livewire.factory.recontrol.show-loreal-recontrols', compact('recontrols'))->layout('layouts.factory');
    }
}
