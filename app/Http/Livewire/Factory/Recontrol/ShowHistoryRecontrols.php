...
class ShowHistoryRecontrols extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $recontrols = Recontrol::whereNotNull('history')
            ->with('client')
            ...
            ->paginate(50);
        return view('livewire.factory.recontrol.show-history-recontrols', compact('recontrols'))->layout('layouts.factory');
    }
}
