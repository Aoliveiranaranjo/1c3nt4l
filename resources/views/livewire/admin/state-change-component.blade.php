<div class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
  ...
  <x-jet-form-section submit="save" class="mb-6">
    <x-slot name="title">
        Agregar estado de cambio
    </x-slot>

    <x-slot name="description">
        En esta sección podrás agregar un nuevo estado de los cambios de maquinas.
    </x-slot>
    ...
    <x-jet-action-section>
        ...
        <x-slot name="description">
            Aquí encontrarás todos los tipos de estados de los cambios.
        </x-slot>
                        ...
                        <td class="py-2">
                            <div class="flex divide-x divide-gray-300 font-semibold ">
                                <a class="pr-2  hover:text-blue-600 cursor-pointer"
                                    wire:click="edit('{{$stateChange->id}}')">Editar</a>
                                <a class="pl-2 hover:text-red-600 cursor-pointer"
                                    wire:click="$emit('deleteStateChange', '{{$stateChange->id }}')">Eliminar</a>
    ...
    @push('script')
    <script>
        livewire.on('deleteStateChange', stateChangeId => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        livewire.emit('delete', stateChangeId);
