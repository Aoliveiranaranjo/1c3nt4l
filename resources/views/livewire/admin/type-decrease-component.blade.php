<div class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <x-jet-form-section submit="save" class="mb-6">
        ...
        <x-slot name="description">
            En esta sección podrás agregar nuevos tipos de cambios
        </x-slot>
        ...
        <x-jet-action-section>
            ...
            <x-slot name="description">
                Aquí encontrarás todos los tipos de cambios.
            </x-slot>
                            ...
                            <td class="py-2">
                                <div class="flex divide-x divide-gray-300 font-semibold ">
                                    <a class="pr-2  hover:text-blue-600 cursor-pointer"
                                        wire:click="edit('{{$decreaseType->id}}')">Editar</a>
                                    <a class="pl-2 hover:text-red-600 cursor-pointer"
                                        wire:click="$emit('deletedecreaseType', '{{$decreaseType->id }}')">Eliminar</a>
    ...
    @push('script')
    <script>
        livewire.on('deletedecreaseType', decreaseTypeId => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        livewire.emit('delete', decreaseTypeId);
