<div class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <x-jet-form-section submit="save" class="mb-6">
        <x-slot name="title">
            Agregar nuevo grupos de trabajos
        </x-slot>

        <x-slot name="description">
            En esta sección podrás agregar nuevos grupos de trabajo
        </x-slot>
    ...
    <x-jet-action-section>
        ...
        <x-slot name="description">
            Aquí encontrarás todos los grupos de trabajo.
        </x-slot>
                        ...
                        <td class="py-2">
                            <div class="flex divide-x divide-gray-300 font-semibold ">
                                <a class="pr-2  hover:text-blue-600 cursor-pointer"
                                    wire:click="edit('{{$group->id}}')">Editar</a>
                                <a class="pl-2 hover:text-red-600 cursor-pointer"
                                    wire:click="$emit('deletegroup', '{{$group->id }}')">Eliminar</a>
    ...
    @push('script')
    <script>
        livewire.on('deletegroup', groupId => {
                Swal.fire({
