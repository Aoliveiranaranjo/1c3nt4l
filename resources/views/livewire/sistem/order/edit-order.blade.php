    ...
    <div class="bg-white shadow-xl rounded-lg p-6">
        <div class="grid grid-cols-1 gap-6 mb-4">
            ...
            <div class="grid grid-cols-3 gap-6 mb-4">
                ...
                <div>
                    <x-jet-label value="Cantidad de PT producida: "/>
                    <x-jet-input

                        value="{{number_format(  $order->qualityProductions->sum('unid')  )}} "
                        type="text"
                        class="w-full text-right bg-green-200" disabled/>
                </div>
                <div>
                    <x-jet-label value="Cantidad pendiente de producir PT: "/>
                    <x-jet-input
                        value="{{ number_format($order->amount - $order->qualityProductions->sum('unid') )}} "
                        type="text"
