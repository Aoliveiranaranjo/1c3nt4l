    ...
    <x-slot name="header">
        <div class="flex items-center">
            <h2 class="text-xl font-semibold leading-tight text-gray-500">
                Listado de producciones en fabricación
            </h2>
        </div>
    </x-slot>
                        ...
                        @foreach ($productions as $production)
                            <tr>
                                <td class="px-6 py-4 text-sm font-medium leading-5 text-right whitespace-no-wrap">
                                    <a href=" {{ route('factory.productions.edit', $production) }} ">
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap">
                                    <div class="text-sm leading-5  text-right text-gray-900">
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap">
                                    <div class="text-sm leading-5  text-right text-gray-900">
                                        {{ $production->productionparts->sum('amount') }}
                                    </div>
