        ...
        <x-table-responsive>
            ...
            <div class="px-6 py-4   flex  justify-end items-center mt-4">
                    ...
                    <div  class="px-3 py-2  mt-2 text-xs" >
                        <x-jet-label value=""/>
                        <x-jet-input
                            value=" Producciones: &nbsp {{  count($qualityProductions) }}"
                            type="text"
            ...
            <div class="bg-white shadow-xl rounded-lg p-6">
                <div class="grid grid-cols-2 gap-6  mb-4">
                    <div>
                        ...
                        <x-jet-input
                            wire:model='qualityProduction.lote_pt'
                            type="text"
                            class="w-full"/>
                    ...
                    <div >
                        ...
                        <x-jet-input
                            wire:model='qualityProduction.sp'
                            type="text"
                            class="w-full"/>
                ...
                <div class="grid grid-cols-2 gap-6  mb-4">
                    <div>
                        ...
                        <x-jet-input
                            wire:model='qualityProduction.lote_conte'
                            type="text"
                            class="w-full"/>
                    ...
                    <div>
                        ...
                        <x-jet-input
                            wire:model='qualityProduction.cuba'
                            type="text"
                            class="w-full"/>
                ...
                <div class="grid grid-cols-3 gap-6  mb-4">
                    <div>
                        ...
                        <x-jet-input
                            wire:model='qualityProduction.palet'
                            type="number"
                            class="w-full"/>
                    ...
                    <div>
                        ...
                        <x-jet-input
                            wire:model='qualityProduction.box'
                            type="number"
                            class="w-full"/>
                    ...
                    <div>
                        ...
                        <x-jet-input
                            wire:model='qualityProduction.unid'
                            type="number"
                            class="w-full"/>
