        ...
        <div class="bg-white shadow-xl rounded-lg p-6">
            ...
            <div class="grid grid-cols-3 gap-6  mb-4">
                ...
                <div>
                    ...
                    <x-jet-input
                        value="{{  date('d/m/Y H:i:s', strtotime($production->start->created_at ?? 'Sin inicio')) }} "
                        type="text"
                ...
                <div>
                    ...
                    <x-jet-input
                        value="{{  date('d/m/Y H:i:s', strtotime($production->start->qualitie->created_at ?? 'Sin inicio')) }} "
                        type="text"
                        class="w-full text-center  bg-gray-200" disabled/>
                </div>
                <div>
                    ...
                    <x-jet-input
                        value="{{ date('d/m/Y H:i:s', strtotime( $production->start->responsible->created_at ?? 'Sin inicio'))  }} "
                        type="text"
                        class="w-full text-center  bg-gray-200" disabled/>
                </div>
            </div>
